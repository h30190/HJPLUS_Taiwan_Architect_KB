...
### 1️⃣0️⃣ [文化資產](文化資產/) Cultural Heritage

**6 個技能模組（6C）**

| 分類 | 技能 | 類別 |
|--|--|--|
| **修復及再利用程序/** | [調查研究](文化資產/修復及再利用程序/調查研究/) \| [修復設計](文化資產/修復及再利用程序/修復設計/) \| [監造與工作報告](文化資產/修復及再利用程序/監造與工作報告/) | C 類台灣法規 |
| **法規排除與因應計畫/** | [再利用因應計畫](文化資產/法規排除與因應計畫/再利用因應計畫/) | C 類台灣法規 |
| **權益補償/** | [容積移轉](文化資產/權益補償/容積移轉/) \| [稅賦減免](文化資產/權益補償/稅賦減免/) | C 類台灣法規 |

> 依據文化資產保存法，涵蓋調查研究、修復設計、監造與工作報告、法規排除因應計畫及私有文資權益補償（容積移轉、稅賦減免）
