...
description: "This skill should be used when an architect receives just an address or lot number (地號) for a site in Taichung City, Taiwan, and needs the land's basic data — zoning, registered land area, land value, building numbers/permits, building overlay (套繪) status, urban planning land-use regulations, geological hazard zones, slope-land restrictions, fire-break setback zones, active fault distances, sewer connection announcements, building-line exemption zones, military restricted-building zones, and whether the parcel or a neighboring parcel falls within a designated cultural heritage asset boundary — plus a head start on the official PDF certificates needed for a later building permit application. Trigger scenarios: site feasibility evaluation from an address/lot number, pre-permit restriction checks and supporting-document gathering, real-estate due diligence, cultural heritage impact screening near a historic site/monument, or converting a Taichung street address to its lot number. Taichung City only."
