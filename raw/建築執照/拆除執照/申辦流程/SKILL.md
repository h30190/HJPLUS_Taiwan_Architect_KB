---
name: building-permit-application-process-demolition
description: "This skill should be used when architects or construction professionals need to understand the application procedures for demolition permits (拆除執照) in Taiwan."
user-invocable: true
---
# 建築執照申辦流程
