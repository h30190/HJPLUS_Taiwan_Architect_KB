---
type: Skill
name: demolition-permit-application-process
description: "This skill should be used when architects or construction professionals need to understand the application procedures for Taiwan demolition permits (拆除執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
