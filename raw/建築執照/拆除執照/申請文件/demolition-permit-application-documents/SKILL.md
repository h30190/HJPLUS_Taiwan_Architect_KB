---
type: Skill
name: demolition-permit-application-documents
description: "This skill should be used when architects or construction professionals need to understand the required application documents for Taiwan demolition permits (拆除執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
