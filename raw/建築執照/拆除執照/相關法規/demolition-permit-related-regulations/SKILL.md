---
type: Skill
name: demolition-permit-related-regulations
description: "This skill should be used when architects or construction professionals need to understand the regulatory framework for Taiwan demolition permits (拆除執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
