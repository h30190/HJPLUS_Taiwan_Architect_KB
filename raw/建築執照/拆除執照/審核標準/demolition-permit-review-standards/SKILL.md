---
type: Skill
name: demolition-permit-review-standards
description: "This skill should be used when architects or construction professionals need to understand the review criteria and compliance requirements for Taiwan demolition permits (拆除執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
...
> 🚧 **TODO: 尚未依執照別分化。** 本檔內容目前在 使用執照 / 建造執照 / 拆除執照 / 雜項執照 四種執照下完全相同，描述的是建築執照的通用規定。請熟悉 拆除執照 的專業者將以下內容替換為該執照別特有的規定。
