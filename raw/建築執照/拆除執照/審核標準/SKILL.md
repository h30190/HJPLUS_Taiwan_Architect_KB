---
name: building-permit-review-standards-demolition
description: "This skill should be used when architects or construction professionals need to understand the review criteria and compliance requirements for demolition permits (拆除執照) in Taiwan."
user-invocable: true
---
# 建築執照審核標準
