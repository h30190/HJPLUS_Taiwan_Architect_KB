---
name: building-permit-related-regulations-occupancy
description: "This skill should be used when architects or construction professionals need to understand the regulatory framework for occupancy permits (使用執照) in Taiwan."
user-invocable: true
---
# 建築執照相關法規
