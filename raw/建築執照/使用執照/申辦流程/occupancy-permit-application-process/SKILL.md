---
type: Skill
name: occupancy-permit-application-process
description: "This skill should be used when architects or construction professionals need to understand the application procedures for Taiwan occupancy permits (使用執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
