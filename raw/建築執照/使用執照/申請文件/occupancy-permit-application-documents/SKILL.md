---
type: Skill
name: occupancy-permit-application-documents
description: "This skill should be used when architects or construction professionals need to understand the required application documents for Taiwan occupancy permits (使用執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
