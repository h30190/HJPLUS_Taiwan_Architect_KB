---
name: building-permit-application-documents-occupancy
description: "This skill should be used when architects or construction professionals need to understand the required application documents for occupancy permits (使用執照) in Taiwan."
user-invocable: true
---
# 建築執照申請文件
