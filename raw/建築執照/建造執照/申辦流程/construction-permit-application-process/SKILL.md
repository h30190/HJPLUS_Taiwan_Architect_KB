---
type: Skill
name: construction-permit-application-process
description: "This skill should be used when architects or construction professionals need to understand the application procedures for Taiwan construction permits (建造執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
