---
type: Skill
name: miscellaneous-permit-review-standards
description: "This skill should be used when architects or construction professionals need to understand the review criteria and compliance requirements for Taiwan miscellaneous permits (雜項執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
