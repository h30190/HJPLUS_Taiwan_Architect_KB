---
type: Skill
name: miscellaneous-permit-related-regulations
description: "This skill should be used when architects or construction professionals need to understand the regulatory framework for Taiwan miscellaneous permits (雜項執照)."
user-invocable: true
metadata:
  class: C
  status: unverified
