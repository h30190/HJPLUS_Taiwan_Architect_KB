...
description: "This skill should be used when planning, designing, or reviewing the water meter installation locations, types, and configurations for buildings in Taiwan according to the Taiwan Water Corporation guidelines. Trigger words: 水表/水錶位置與安裝、水表箱、台灣自來水公司規定。"
metadata:
  class: C
---
