...
description: "This skill should be used when designing architectural acoustics, including room acoustics, noise control, and sound insulation. Trigger words: 隔音設計、噪音控制、室內音響、樓板衝擊音。 整體IEQ多系統評估請用indoor-environment。"
user-invocable: true
metadata:
  class: B
---
...
> ⚠️ 以下內容以 ISO 16283、ASTM E90 為基準，**尚未完成台灣在地化**。引用任何數值前，請先依本檔「Taiwan Adaptation Notes」的待辦項目查證對應的台灣法規。
